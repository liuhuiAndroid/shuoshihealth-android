 ...
 */
public class ImageDiagnoseEndPresenter implements ImageDiagnoseEndContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private CommonApi mCommonApi;
    private ImageDiagnoseEndContract.View mView;
    private int page = 1;
    private int state = 1;

    @Inject
    public ImageDiagnoseEndPresenter(CommonApi commonApi) {
    ...
    @Override
    public void attachView(@NonNull ImageDiagnoseEndContract.View view) {
        mView = view;
    }
