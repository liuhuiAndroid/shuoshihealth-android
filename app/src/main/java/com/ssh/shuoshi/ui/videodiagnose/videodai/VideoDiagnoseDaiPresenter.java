 ...
 */
public class VideoDiagnoseDaiPresenter implements VideoDiagnoseDaiContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private CommonApi mCommonApi;
    private VideoDiagnoseDaiContract.View mView;
    private int page = 1;
    private int state = 2;

    @Inject
    public VideoDiagnoseDaiPresenter(CommonApi commonApi) {
    ...
    @Override
    public void attachView(@NonNull VideoDiagnoseDaiContract.View view) {
        mView = view;
    }
