 ...
 */
public class MyPrescriptionIngPresenter implements MyPrescriptionIngContract.Presenter{

    private final CompositeDisposable disposables = new CompositeDisposable();
    private CommonApi mCommonApi;
    private MyPrescriptionIngContract.View mView;
    private int page = 1;
    private int state = 3;

    @Inject
    public MyPrescriptionIngPresenter(CommonApi commonApi) {
    ...
    @Override
    public void attachView(@NonNull MyPrescriptionIngContract.View view) {
        mView = view;
    }
