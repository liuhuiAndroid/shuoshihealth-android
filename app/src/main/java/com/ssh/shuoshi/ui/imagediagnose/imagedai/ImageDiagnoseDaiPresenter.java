 ...
 */
public class ImageDiagnoseDaiPresenter implements ImageDiagnoseDaiContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private CommonApi mCommonApi;
    private ImageDiagnoseDaiContract.View mView;
    private int page = 1;
    private int state = 1;

    @Inject
    public ImageDiagnoseDaiPresenter(CommonApi commonApi) {
    ...
    public void loadData() {
        disposables.add(mCommonApi.getTuWaitList(page, state)
...
//                        mView.onLoadCompleted(beans.getRows().size() == 10);
    ...
    @Override
    public void attachView(@NonNull ImageDiagnoseDaiContract.View view) {
        mView = view;
    }
