 ...
 */
public class VideoDiagnoseIngFragment extends BaseFragment implements PtrHandler,
        VideoDiagnoseIngContract.View, LoadMoreWrapper.OnLoadMoreListener, TIMMessageListener {
    ...
    @Inject
    VideoDiagnoseIngPresenter mPresenter;
    ...
    public void onRefreshCompleted(ImageDiagnoseBean beans, boolean isClear) {
        ...
        EventBus.getDefault().post(new ChangeTuNumEvent("second", beans.getTotal(), 2));
        if (isClear) {
            mData.clear();
        }
