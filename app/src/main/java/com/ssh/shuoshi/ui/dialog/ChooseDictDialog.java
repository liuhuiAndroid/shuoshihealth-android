 ...
 */
public class ChooseDictDialog extends Dialog implements View.OnClickListener {

    private String mTitle;
    private List<SystemTypeBean.RowsBean> mData;
    private Context mContext;
    private ItemClickListener mItemClickListener;

    public ChooseDictDialog(@NonNull Context context, String title, List<SystemTypeBean.RowsBean> list) {
        super(context);
    ...
    public ChooseDictDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected ChooseDictDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CommonAdapter mCommonAdapter = new CommonAdapter<SystemTypeBean.RowsBean>(mContext, R.layout.choose_item_dialog_item, mData) {

            @Override
            protected void convert(ViewHolder holder, final SystemTypeBean.RowsBean rowsBean, int position) {
                holder.setText(R.id.tv_name, rowsBean.getDictLabel());
            }
        };
        ...
        mCommonAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                if (mItemClickListener != null) {
                    mItemClickListener.choose(mData.get(position).getDictLabel());
                }
            }
