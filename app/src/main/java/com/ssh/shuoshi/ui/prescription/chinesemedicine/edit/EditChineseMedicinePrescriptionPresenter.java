...
public class EditChineseMedicinePrescriptionPresenter implements EditChineseMedicinePrescriptionContract.Presenter {
    ...
    @Override
    public void attachView(@NonNull EditChineseMedicinePrescriptionContract.View view) {
        mView = view;
    }
    ...
    @Override
    public void addPrescription(Map<String, Object> mMap) {
        disposables.add(mCommonApi.addPrescription(mMap)
                .debounce(800, TimeUnit.MILLISECONDS)
                ...
                .subscribe(bean -> {
                    Log.i("hhh", "中成药:   " + new Gson().toJson(bean));
                    mView.addPrescriptionSuccess(bean);
    ...
    @Override
    public void putPrescription(Map<String, Object> mMap) {
        disposables.add(mCommonApi.putPrescription(mMap)
                .debounce(800, TimeUnit.MILLISECONDS)
                .flatMap((Function<HttpResult<Integer>, ObservableSource<Integer>>)
                        loginEntityHttpResult -> CommonApi.flatResponse(loginEntityHttpResult))
                .observeOn(AndroidSchedulers.mainThread())
