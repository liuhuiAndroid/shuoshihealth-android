 ...
 */
public class MyPrescriptionIngFragment extends BaseFragment implements PtrHandler,
        MyPrescriptionIngContract.View, LoadMoreWrapper.OnLoadMoreListener {
    ...
    @Inject
    MyPrescriptionIngPresenter mPresenter;
