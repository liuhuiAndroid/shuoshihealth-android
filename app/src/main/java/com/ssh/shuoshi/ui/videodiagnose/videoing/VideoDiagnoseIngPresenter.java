 ...
 */
public class VideoDiagnoseIngPresenter implements VideoDiagnoseIngContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private CommonApi mCommonApi;
    private VideoDiagnoseIngContract.View mView;
    private int page = 1;
    private int state = 2;

    @Inject
    public VideoDiagnoseIngPresenter(CommonApi commonApi) {
    ...
    public void loadData() {
        disposables.add(mCommonApi.getTuTalkingList(page, state)
    ...
    @Override
    public void attachView(@NonNull VideoDiagnoseIngContract.View view) {
        mView = view;
    }
