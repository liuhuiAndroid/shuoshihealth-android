...
public class PrescriptionOrderAdapter extends RecyclerView.Adapter<PrescriptionOrderAdapter.PatientViewHolder> {
    ...
    public PatientViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_prescription_order, parent, false);
