 ...
 */
public class MyPrescriptionFailFragment extends BaseFragment implements PtrHandler,
        MyPrescriptionFailContract.View, LoadMoreWrapper.OnLoadMoreListener {
    ...
    @Inject
    MyPrescriptionFailPresenter mPresenter;
    ...
    public void onRefreshCompleted(PrescriptionStateBean beans, boolean isClear) {
        ...
        if (mCommonAdapter == null) {
            mCommonAdapter = new CommonAdapter<PrescriptionStateBean.RowsBean>(getActivity(), R.layout.fragment_my_prescription_fail_item, mData) {
                @Override
                protected void convert(ViewHolder holder, final PrescriptionStateBean.RowsBean bean, int position) {
                    ...
                    Button buttonRestart = holder.getView(R.id.buttonRestart);
