...
public class CommonlyPrescriptionChinesePresenter implements CommonlyPrescriptionChineseContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private CommonApi mCommonApi;
    private CommonlyPrescriptionChineseContract.View mView;
    private int page = 1;
    private int perscriptionTypeId = 2;

    @Inject
    public CommonlyPrescriptionChinesePresenter(CommonApi commonApi) {
    ...
    @Override
    public void attachView(@NonNull CommonlyPrescriptionChineseContract.View view) {
        mView = view;
    }
