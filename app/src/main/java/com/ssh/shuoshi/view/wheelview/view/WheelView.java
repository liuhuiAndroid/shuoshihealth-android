package com.ssh.shuoshi.view.wheelview.view;
...
import com.ssh.shuoshi.view.wheelview.adapter.WheelAdapter;
import com.ssh.shuoshi.view.wheelview.interfaces.IPickerViewData;
import com.ssh.shuoshi.view.wheelview.listener.LoopViewGestureListener;
import com.ssh.shuoshi.view.wheelview.listener.OnItemSelectedListener;
import com.ssh.shuoshi.view.wheelview.timer.InertiaTimerTask;
import com.ssh.shuoshi.view.wheelview.timer.MessageHandler;
import com.ssh.shuoshi.view.wheelview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    //获得接口对象的方法。
    public void setOnItemSelectListener(OnClickListener listener) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle > 90F || angle < -90F) {
                ...
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    canvas.drawText(contentText, drawCenterContentStart, Y - 8, paintCenterText);
                    //设置选中项
    ...
    private void setOutPaintStyle(float offsetCoefficient, float angle) {
        // 控制文字倾斜角度
        float DEFAULT_TEXT_TARGET_SKEW_X = 0.1f;
        int multiplier = 0;
        if (textXOffset > 0) {
            multiplier = 1;
