...
import com.ssh.shuoshi.view.pickview.configure.PickerOptions;
...
//        wheelOptions.setTextColorCenter(mPickerOptions.textColorCenter);
        ...
        wheelOptions.setDividerColor(0xFFF5F5F5);
        wheelOptions.setDividerType(mPickerOptions.dividerType);
        wheelOptions.setLineSpacingMultiplier(mPickerOptions.lineSpacingMultiplier);
        wheelOptions.setTextColorOut(0x999999);
        wheelOptions.setTextColorCenter(0xFF333333);

        wheelOptions.isCenterLabel(mPickerOptions.isCenterLabel);

        wheelOptions.getWv_option1().setOnItemSelectListener(new View.OnClickListener() {
            @Override
        ...
        wheelOptions.getWv_option2().setOnItemSelectListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                returnData();
                dismiss();
