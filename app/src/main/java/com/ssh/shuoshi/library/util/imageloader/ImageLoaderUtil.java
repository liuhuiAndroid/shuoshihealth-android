...
import com.ssh.shuoshi.library.util.imageloader.glideprogress.ProgressLoadListener;
import com.ssh.shuoshi.library.util.imageloader.listener.ImageSaveListener;
import com.ssh.shuoshi.library.util.imageloader.listener.SourceReadyListener;
...
//        mStrategy.loadImage(url, imageView);
    ...
    public void loadImage(Integer resourceId, int placeholder, ImageView imageView) {
        mStrategy.loadImage(imageView.getContext(), resourceId, placeholder, imageView);
    }
