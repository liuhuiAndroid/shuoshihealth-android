...
public class StatefulLayout extends FrameLayout {
    ...
    public void showLoading(StatusfulConfig statusfulConfig) {
        switchState(LOADING, statusfulConfig);
    }
    ...
    private void setLoadingView(StatusfulConfig statusfulConfig) {
        if (loadingStateFrameLayout == null) {
            ...
            loadingStateTextView = (TextView) view.findViewById(R.id.textview_loading);

            if (statusfulConfig != null) {
                if (!TextUtils.isEmpty(statusfulConfig.getLoadingText())) {
                    loadingStateTextView.setText(statusfulConfig.getLoadingText());
                }
            }
