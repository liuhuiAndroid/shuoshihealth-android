...
public abstract class TRTCCalling {
     ...
     * @param roomId
     */
    public abstract void groupCall(List<String> userIdList, int type, String groupId, int roomId);
     ...
     * @param timeCount
     */
    public abstract void reject(int timeCount);
     ...
     * @param mTimeCount
     */
    public abstract void hangup(int mTimeCount);
