...
public abstract class ChatManagerKit extends V2TIMAdvancedMsgListener implements MessageRevokedManager.MessageRevokeHandler {
    ...
    protected static final int MSG_PAGE_COUNT = 100;
    ...
    public void sendMessage(final MessageInfo message, boolean retry, final IUIKitCallBack callBack) {
        ...
        // TODO OPPO必须设置ChannelID才可以收到推送消息，这个channelID需要和控制台一致
        v2TIMOfflinePushInfo.setAndroidOPPOChannelID("im_chat");
        ...
        if (msgType == MessageInfo.MSG_TYPE_CUSTOM) {
            ...
            String myUserName = MMKV.defaultMMKV().getString("IM__MY_USER_NAME", "");
            v2TIMOfflinePushInfo.setTitle(myUserName);
