...
public abstract class RangeMonthView extends BaseMonthView {
    ...
    private void draw(Canvas canvas, Calendar calendar, int i, int j) {
        ...
        if (mDelegate.clickCalendar != null && mDelegate.clickCalendar.getMonth() == calendar.getMonth() &&
                mDelegate.clickCalendar.getDay() == calendar.getDay()) {
            isToday = true;
        }
        if (isSelected) {
            onDrawSelected(canvas, calendar, x, y, false, isPreSelected, isNextSelected, isToday);
        }
        onDrawText(canvas, calendar, x, y, hasScheme, isSelected, isToday);
    ...
    public void onClick(View v) {
        ...
        mDelegate.clickCalendar = calendar;
        Calendar calendarCopy = new Calendar();
        calendarCopy.setYear(calendar.getYear());
        calendarCopy.setMonth(calendar.getMonth());
        calendarCopy.setDay(calendar.getDay());
        ...
        mDelegate.mSelectedStartRangeCalendar = calendarCopy;
        ...
        mDelegate.mSelectedEndRangeCalendar = calendarCopy2;
    ...
    protected abstract boolean onDrawSelected(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme,
                                              boolean isSelectedPre, boolean isSelectedNext, boolean isToday);
     ...
     * @param isToday
     */
    protected abstract void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected, boolean isToday);
}
