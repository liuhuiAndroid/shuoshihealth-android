...
public class CalendarViewDelegate {
     ...
     * 选择范围日历
     */
    Calendar mSelectedStartRangeCalendar, mSelectedEndRangeCalendar, clickCalendar;

    public Calendar getSelectedStartRangeCalendar() {
        return mSelectedStartRangeCalendar;
    }

    public void setSelectedStartRangeCalendar(Calendar mSelectedStartRangeCalendar) {
        this.mSelectedStartRangeCalendar = mSelectedStartRangeCalendar;
    }
    ...
    public void setSelectedEndRangeCalendar(Calendar mSelectedEndRangeCalendar) {
        this.mSelectedEndRangeCalendar = mSelectedEndRangeCalendar;
    }
    ...
    public void setClickCalendar(Calendar clickCalendar) {
        this.clickCalendar = clickCalendar;
    }
